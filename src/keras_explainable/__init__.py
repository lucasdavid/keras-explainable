...
from keras_explainable.engine.explaining import explain, partial_explain
...
gradcampp = partial_explain(methods.cams.gradcampp, postprocessing=filters.positive_normalize)
scorecam = partial_explain(methods.cams.scorecam, postprocessing=filters.positive_normalize)
